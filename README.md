...
# 4. How to run
Weights for our modified CycleGAN network trained on simulated images from VR-CAPS and real images from EndoMapper can be found here: [**Weights**](https://unizares-my.sharepoint.com/:f:/g/personal/794524_unizar_es/IgAsyCf99WtTQaVP94mUj2iHAUQqlzTDPcF4BmwXt-_7eqw?e=5CH9UC)
# 5. Fold segmentation annotations and results
Data used in our paper for train and test can be found [**here**](https://unizares-my.sharepoint.com/:f:/g/personal/794524_unizar_es/IgAsyCf99WtTQaVP94mUj2iHAUQqlzTDPcF4BmwXt-_7eqw?e=5CH9UC), containing RGB images (folder *original.zip*) with binary (folder *gt.zip*) and instance (folder *inst.zip*) ground-truth segmentation masks, depth maps (folder *depth.zip*) for simulated images, simulated images with added realistic texture (folder *original_aug.zip*) .
