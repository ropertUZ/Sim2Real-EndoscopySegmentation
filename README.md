...
# 4. How to run
Weights for our modified CycleGAN network trained on simulated images from VR-CAPS and real images from EndoMapper can be found here: [**Weights**]([https://drive.google.com/drive/folders/1oS8HHqoYd5FFLuCjmFix1r9CrTLkpWMy?usp=drive_link)](https://unizares-my.sharepoint.com/:f:/g/personal/ctomasini_unizar_es/EsUdd6siDVlNm21XxEePvaoBRfmKR-wtM5NoEuq8IhzU0w?e=NT0UbH)
